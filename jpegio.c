...
struct __pyx_vtabstruct_7libjpeg_DecompressedJpeg {
  ...
  PyObject *(*_arrange_blocks)(struct __pyx_obj_7libjpeg_DecompressedJpeg *, PyArrayObject *, struct DctBlockArraySize);
};
 ...
 * 
 */
  __pyx_tuple__8 = PyTuple_Pack(3, __pyx_n_s_n, __pyx_n_s_dtype, __pyx_n_s_arr); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(2, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_jpegio_pyx, __pyx_n_s_test, 21, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 21, __pyx_L1_error)
 ...
 *     return obj
 */
  __pyx_tuple__10 = PyTuple_Pack(1, __pyx_n_s_obj); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(0, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_jpegio_pyx, __pyx_n_s_test_jpeg_decompress, 26, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("libjpeg"); if (unlikely(!__pyx_t_1)) __PYX_ERR(3, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_7libjpeg_DecompressedJpeg = __Pyx_ImportType(__pyx_t_1, "libjpeg", "DecompressedJpeg", sizeof(struct __pyx_obj_7libjpeg_DecompressedJpeg), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7libjpeg_DecompressedJpeg) __PYX_ERR(3, 12, __pyx_L1_error)
  __pyx_vtabptr_7libjpeg_DecompressedJpeg = (struct __pyx_vtabstruct_7libjpeg_DecompressedJpeg*)__Pyx_GetVtable(__pyx_ptype_7libjpeg_DecompressedJpeg->tp_dict); if (unlikely(!__pyx_vtabptr_7libjpeg_DecompressedJpeg)) __PYX_ERR(3, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;

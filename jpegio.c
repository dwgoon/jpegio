 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_CallNoArg(((PyObject *)__pyx_ptype_7libjpeg_JpegDecompress)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_vtabptr_7libjpeg_JpegDecompress = (struct __pyx_vtabstruct_7libjpeg_JpegDecompress*)__Pyx_GetVtable(__pyx_ptype_7libjpeg_JpegDecompress->tp_dict); if (unlikely(!__pyx_vtabptr_7libjpeg_JpegDecompress)) __PYX_ERR(3, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
